clear
load roboflapperParamSweep_20x20_02to1.mat
...
%% save data as individual arrays



save('osc_amp', 'est_amp_array')
save('freq', 'freq_array');
save('power', 'conv_array');
save('synch_gain_range', 'synch_gain_range')
save('r3_range', 'r3_range')
